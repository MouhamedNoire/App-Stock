...
class __TwigTemplate_a4497a9bd2f64c69f8acd7141c93a559 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        echo "<form method=\"post\" class=\"from-control\" action=\"";
...
";
    ...
    {
        return new Source("<form method=\"post\" class=\"from-control\" action=\"{{ path('app_user_delete', {'id': user.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button class=\"btn btn-danger mt-2\">Delete</button>
</form>
", "user/_delete_form.html.twig", "C:\\Users\\ordi\\App-Stock\\templates\\user\\_delete_form.html.twig");
    }
}
